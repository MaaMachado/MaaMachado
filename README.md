...
#### - :heavy_check_mark: Tenho conhecimentos em inglês (básico), libras (inicial/básico), espanhol (intermediário 1) e tenho como língua materna, o português.
...
#### - :book::video_game: Hobbies: ler, programar sites web e jogar The Sims.
